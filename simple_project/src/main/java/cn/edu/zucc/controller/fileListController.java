...
public class fileListController {
    ...
    public Map<String,String> upload(@RequestParam("file")MultipartFile file) throws IOException {
        ...
        file.transferTo(new File("C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest\\"+file.getOriginalFilename()));
    ...
    public ArrayList<String> getFileList() throws IOException {
        ...
        //file.transferTo(new File("C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest\\"+file.getOriginalFilename()));
        File file = new File("C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest");
    ...
    public String deleteFileByName(@RequestBody String name) throws IOException {
        //file.transferTo(new File("C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest\\"+file.getOriginalFilename()));
        File file = new File("C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest\\"+name.substring(5));
        if(!file.exists()){
            return "文件不存在";
        }else{
            file.delete();
    ...
    public ResponseEntity downloadFileByName(@RequestBody String name) throws IOException {
        //file.transferTo(new File("C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest\\"+file.getOriginalFilename()));
        String filePath = "C:\\Users\\伊钱耀\\Desktop\\信息系统分析设计与开发\\uploadtest\\"+name.substring(5);
